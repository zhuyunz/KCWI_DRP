...
class MakeMasterSky(BaseImg):
    ...
    def _pre_condition(self):
        ...
        :return:
        """
        self.logger.info("Running MakeMasterSky_verbose - look for .txt files!")
        self.logger.info("Checking precondition for MakeMasterSky_verbose")
    ...
    def _perform(self):
        ...
        bspline_tab['bkpt'] = bkpt
        ascii.write(bspline_tab, f'{os.path.join(
            self.config.instrument.cwd, 'redux')}/bspline_tab-{groot}.txt')
