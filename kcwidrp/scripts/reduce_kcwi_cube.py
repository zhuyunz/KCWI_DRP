...
def main():
    ...
    if args.stage is None:
        ...
        from kcwidrp.pipelines.kcwi_pipeline_precube import Kcwi_pipeline
        print("Stop after sky subtraction")
    elif args.stage==2:
        from kcwidrp.pipelines.kcwi_pipeline_cube import Kcwi_pipeline
        print("Only making cubes")
